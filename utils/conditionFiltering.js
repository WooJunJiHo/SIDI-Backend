                ...
                messages: [
                    {
                        role: 'system', content:
                            `
                                ...
                                [클래스]
                                1. 새상품: 미개봉 제품
                                2. 이상 없음: 기스, 스크래치, 찍힘, 흠집 등이 없고 액정과 가능상에 이상이 없는 제품
                                3. 기스: 기스, 스크레치, 찍힘, 흠집, 사용감, 생활기스 등이 있는 제품
                                4. 액정 파손: 액정이 깨져있거나 금가있는 문제있는 제품
                                5. 외판 손상: 액정을 제외한 나머지 부분에 파손이 있는 제품
                                6. 기능 고장: 버튼 고장, 카메라 고장, 페이스 아이디 고장 등 기능 사용에 있어서 문제가 있는 제품

                                [분류 주의사항]
                                1. 클래스 분류의 기준은 prompt의 info를 보고 손상도의 상세 설명을 참조합니다.
                                2. 해당되는 클래스가 많다면 손상도가 높은 한 개를 적용합니다.
                                    - 손상도: 기능 고장 > 액정 파손 > 외판 손상 > 기스 > 이상 없음 > 새상품
